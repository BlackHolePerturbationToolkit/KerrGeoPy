...
import numpy as np
from scipy.special import ellipj, ellipeinc, ellipe
...
def plunging_radial_integrals(a,E,L,Q):
   # standard form of the radial polynomial R(r)
    ...
    def I_r(mino_time):
        # equation 43
        sn, cn, dn, xi_r = ellipj(sqrt((1-E**2)*A*B)*mino_time,k_r**2)
        # equation 46
